...
def pco2_fass(**kwargs):
    ...
    'pCO2' = observed monthly pCO2 (e.g. 1982-2022 monthly pCO2 from OceanSODA-ETHZ) (uatm)
    ...
    # - - -
    # Step 1: solve for pCO2_AM (eqn 4 in Rodgers et al)
    ...
    # - - -
    # Step 2: solve for pCO2_TFASS (eqn 5 in Rodgers et al)
    kwargs = dict(
        par1_type = 1,  # The first parameter supplied is of type "1", which means "alkalinity"
        par1 = TAbar,  # value of the first parameter
        par2_type = 2,  # The second parameter 2=DIC, 4=pCO2, 5=fCO2
    ...
    # Run PyCO2SYS
    results = pyco2.sys(**kwargs)
    pCO2_TFASS = results['pCO2']

    # - - -
    # Step 3: solve for pCO2_Tanom (eqn 6 in Rodgers et al)
    pCO2_Tanom = pCO2_TFASS - pCO2_AM

    # - - -
    # Step 4: solve for pCO2_NTFASS (eqn 7 in Rodgers et al)
