...
def fCO2_to_pCO2(fCO2, TempC, RGas=83.1451, pressure_atmosphere=1.0):
...
def pCO2_to_fCO2(pCO2, TempC, RGas=83.1451, pressure_atmosphere=1.0):
...
def fugacityfactor(TempC, RGas=83.1451, pressure_atmosphere=1.0):
