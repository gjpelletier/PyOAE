...
- Calculation of the maximum hypothetical OAE efficiency "etamax" for any assumed addition of alkalinity. The etamax is calculated as the hypothetical maximum potential CDR divided by the amount of added alkalinity.
