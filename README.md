...
As an alternative, you can download PyOAE.py from this github repository (https://github.com/gjpelletier/PyOAE) and copy and paste both functions into your own project.<br>
